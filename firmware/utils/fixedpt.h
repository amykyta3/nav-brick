...
static inline uint8_t mpy_Q8(uint8_t x, uint8_t Q8){
    uint16_t P;
    P = (uint16_t)x * Q8;
    P >>= 8;
    return(P);
...
static inline uint16_t mpy_Q16(uint16_t x, uint16_t Q16){
    uint32_t P;
    P = (uint32_t)x * Q16;
    P >>= 16;
    return(P);
...
static inline uint32_t mpy_Q32(uint32_t x, uint32_t Q32){
    uint64_t P;
    P = (uint64_t)x * Q32;
    P >>= 32;
    return(P);
...
static inline int8_t mpys_Q8(int8_t x, uint8_t Q8){
    int16_t P;
    P = (int16_t)x * Q8;
    P >>= 8;
    return(P);
...
static inline int16_t mpys_Q16(int16_t x, uint16_t Q16){
    int32_t P;
    P = (int32_t)x * Q16;
    P >>= 16;
    return(P);
...
static inline int32_t mpys_Q32(int32_t x, uint32_t Q32){
    int64_t P;
    P = (int64_t)x * Q32;
    P >>= 32;
    return(P);
